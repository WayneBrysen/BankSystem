...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/Brysen/simplebank/db/sqlc Store
	mockgen -package mockwk -destination worker/mock/distributor.go github.com/Brysen/simplebank/worker TaskDistributor
