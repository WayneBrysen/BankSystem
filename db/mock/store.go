...
// Source: github.com/Brysen/simplebank/db/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/Brysen/simplebank/db/sqlc"
...
func (m *MockStore) UpdateTransfer(arg0 context.Context, arg1 sqlc.UpdateTransferParams) (sqlc.Transfer, error) {
	m.ctrl.T.Helper()
